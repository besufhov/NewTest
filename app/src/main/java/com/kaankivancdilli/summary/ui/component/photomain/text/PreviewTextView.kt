...
import com.kaankivancdilli.summary.ui.component.photomain.text.layout.TextItem
...
fun PreviewTextView(
    ...
    onDone: (String) -> Unit, // ✅ Callback to navigate with text
    animatedHeight: Dp,
    isExpanded: Boolean,
    ...
    Column(
        ...
        Row(
            ...
            Button(
                ...
                shape = MaterialTheme.shapes.large, // Keep default shape
                border = BorderStroke(0.05.dp, Color.LightGray),
                elevation = ButtonDefaults.buttonElevation(1.dp)
            ) {
                Icon(
                    imageVector = Icons.Outlined.Clear, // Replace with any icon you want
            ...
            // ✅ Done Button (Navigates to ObjectView)
            Button(
                onClick = {
                ...
                shape = MaterialTheme.shapes.large, // Keep default shape
                border = BorderStroke(0.05.dp, Color.LightGray),
                elevation = ButtonDefaults.buttonElevation(1.dp) // Ensures default border behavior
            ) {
                Icon(
            ...
            Button(
                ...
                Icon(
                    imageVector = Icons.Outlined.CopyAll, // Replace with any icon you want
